    ...
    <section className="relative min-h-[80vh] flex flex-col items-center justify-center px-4 py-20 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center space-y-8">
        <motion.div
          ...
          <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-surface-highlight border border-primary/20 text-primary text-sm font-medium mb-6">
        ...
        <motion.div
          ...
          <button className="group relative px-8 py-4 bg-primary text-black font-bold rounded-lg overflow-hidden transition-transform active:scale-95 hover:shadow-[0_0_20px_rgba(245,158,11,0.3)]">
          ...
          <button
            ...
            className="px-8 py-4 bg-surface border border-white/10 text-white rounded-lg hover:bg-surface-highlight transition-colors active:scale-95">
